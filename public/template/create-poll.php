			...
			<form id="wbpolls-create" class="wbpolls-create">
				...
				<div class="form-group">
					...
					<select class="form-control" name="poll_type" id="poll_type">
						<option value="" <?php if ($poll_type == '') {
												echo "selected";
											} ?>><?php esc_html_e('Select Poll Type', 'buddypress-polls'); ?></option>
						<option value="default" <?php if ($poll_type == 'default') {
													echo "selected";
												} ?>><?php esc_html_e('Text', 'buddypress-polls'); ?></option>
						<option value="image" <?php if ($poll_type == 'image') {
													echo "selected";
												} ?>><?php esc_html_e('Image', 'buddypress-polls'); ?></option>
						<option value="video" <?php if ($poll_type == 'video') {
													echo "selected";
												} ?>><?php esc_html_e('Video', 'buddypress-polls'); ?></option>
						<option value="audio" <?php if ($poll_type == 'audio') {
													echo "selected";
												} ?>><?php esc_html_e('Audio', 'buddypress-polls'); ?></option>
						<option value="html" <?php if ($poll_type == 'html') {
													echo "selected";
					...
					<div class="wbpolls-answer-wrap">
						<div class="row wbpoll-list-item" id="type_image" style="">
							<div class="ans-records image_records_edit">
								...
								<a class="add-field extra-fields-image-edit" data-id="<?php echo count($options); ?>" href="#">Add More</a>
							</div>
								...
								foreach ($options as $key => $optn) {
									if ($key != 0) { ?>
										<div class="remove remove<?php echo count($options); ?>">
											...
											<a class="add-field extra-fields-image-edit" data-id="<?php echo count($options); ?>" href="#">Add More</a>
											<a href="#" class="remove-field btn-remove-image">Remove Fields</a>
										</div>
					...
					<div class="wbpolls-answer-wrap">
						<div class="row wbpoll-list-item" id="type_video" style="">
							<div class="ans-records video_records_edit">
								<div class="ans-records-wrap">
									...
									<div class="wbpoll-image-input-details">
										...
										<div class="wbpoll-input-group-suggestions hide_suggestion" style="display:none;">
											...
											<input type="checkbox" class="yes_video" id="yes" name="_wbpoll_video_import_info[]" value="yes" <?php if ($options[0]['suggestion'] == 'yes') {
																																					echo "checked";
																																				} ?>>
											<label for="yes">Yes</label>
											<input type="checkbox" id="no" name="_wbpoll_video_import_info[]" value="no" <?php if ($options[0]['suggestion'] == 'no') {
																																echo "checked";
																															} ?>>
								...
								<a class="add-field extra-fields-video-edit" data-id="<?php echo count($options); ?>" href="#">Add More</a>
							</div>
										...
										<div class="remove remove2">
											<div class="ans-records-wrap">
												...
												<div class="wbpoll-image-input-details">
													...
													<div class="wbpoll-input-group-suggestions hide_suggestion" style="display:none;">
														<span>Import information from ?</span>
														<input type="checkbox" class="yes_video" id="yes" name="_wbpoll_video_import_info[]" value="yes" <?php if ($optn['suggestion'] == 'yes') {
																																								echo "checked";
																																							} ?>>
														<label for="yes">Yes</label>
														<input type="checkbox" id="no" name="_wbpoll_video_import_info[]" value="no" <?php if ($optn['suggestion'] == 'no') {
																																			echo "checked";
																																		} ?>>
														<label for="no">No</label>
													</div>
											...
											<a class="add-field extra-fields-video-edit" data-id="<?php echo count($options); ?>" href="#">Add More</a>
											<a href="#" class="remove-field btn-remove-video">Remove Fields</a>
										</div>
					...
					<div class="wbpolls-answer-wrap">
						<div class="row wbpoll-list-item" id="type_audio" style="">
							<div class="ans-records audio_records_edit">
								<div class="ans-records-wrap">
									...
									<div class="wbpoll-image-input-details">
										...
										<div class="wbpoll-input-group-suggestions hide_suggestion" style="display:none;"><span>Import information from ?</span>
											...
											<label for="yes">Yes</label>
											<input type="checkbox" id="no" name="_wbpoll_audio_import_info[]" value="no" <?php if ($options[0]['suggestion'] == 'no') {
																																echo "checked";
																															} ?>>
								...
								<a class="add-field extra-fields-audio-edit" data-id="<?php echo count($options); ?>" href="#">Add More</a>
							</div>
								...
								foreach ($options as $key => $optn) {
									if ($key != 0) { ?>
										<div class="remove remove2">
											<div class="ans-records-wrap">
												...
												<div class="wbpoll-image-input-details">
													...
													<div class="wbpoll-input-group-suggestions hide_suggestion" style="display:none;"><span>Import information from ?</span>
														...
														<label for="yes">Yes</label>
														<input type="checkbox" id="no" name="_wbpoll_audio_import_info[]" value="no" <?php if ($optn['suggestion'] == 'no') {
																																			echo "checked";
																																		} ?>>
														<label for="no">No</label><br>
													</div>
											...
											<a class="add-field extra-fields-audio-edit" data-id="<?php echo count($options); ?>" href="#">Add More</a>
											<a href="#" class="remove-field btn-remove-audio">Remove Fields</a>
										</div>
								...
								foreach ($options as $key => $optn) {
									if ($key != 0) { ?>
										<div class="remove remove1">
											...
											<a class="add-field extra-fields-html-edit" data-id="<?php echo count($options); ?>" href="#">Add More</a>
											<a href="#" class="remove-field btn-remove-html">Remove Fields</a>
										</div>
					...
					<table class="form-table wbpoll-answer-options">
						<tbody>
							...
							if ($wbpolls_user_add_extra_op == 'yes') { ?>
								<tr id="addtitonal_option" style="<?php if ($poll_type == 'default') { echo 'display:block;';}else{echo 'display:none;'; }?>">
									...
									<td>
										<fieldset class="radio_fields">
											...
											<label class="wbpoll-answer-options-radio-field" title="g:i a" for="_wbpoll_multivote-radio">
												<?php
												if(isset($_GET['poll_id']) && $_GET['poll_id'] || sanitize_text_field(wp_unslash($_GET['poll_id']))){
													$post_id = isset($_GET['poll_id']) ? sanitize_text_field(wp_unslash($_GET['poll_id'])) : '';
