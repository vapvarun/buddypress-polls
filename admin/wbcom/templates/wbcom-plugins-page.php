	...
	<div class="wbcom-wrap wbcom-plugin-wrapper">    	
		<div class="wbcom_admin_header-wrapper">
			<div id="wb_admin_plugin_name">
				<?php esc_html_e( 'Themes & Extension', 'buddypress-polls' ); ?>
			</div>
		...
		<div class="wbcom-all-addons-plugins-wrap">	
			<div class="wbcom-bp-addons-plugins-list">
				<div class="wbcom-bp-addons-plugins-title-section">
					<ul class="wbcom-addons-plugins-links">
						<li><a href="javascript:void(0)" data-link="paid_extension" class="wbcom-addons-link-active"><?php esc_html_e( 'Paid Extension', 'buddypress-polls' ); ?></a></li>
						<li><a href="javascript:void(0)" data-link="free_extension"><?php esc_html_e( 'Free Extension', 'buddypress-polls' ); ?></a></li>
						<li><a href="javascript:void(0)" data-link="learndash_extension"><?php esc_html_e( 'LearnDash Extension', 'buddypress-polls' ); ?></a></li>
						<li><a href="javascript:void(0)" data-link="our_themes"><?php esc_html_e( 'Our Themes', 'buddypress-polls' ); ?></a></li>
					</ul>
				</div>
				<div id="wbcom_paid_extention" class="wbcom-bp-addons-plugins-list wbcom-bp-free-addon-plugins">
					<div class="wbcom-bp-addons-plugins-title-section">
						<h4 class="wbcom-plugin-heading"><?php esc_html_e( 'Paid Extension', 'buddypress-polls' ); ?></h4>
						<a href="<?php echo esc_url( 'https://wbcomdesigns.com/plugins/premium-buddypress-add-ons/' ); ?>" class="wbcom-addons-button" target="_blank"><?php esc_html_e( 'View More Extensions', 'buddypress-polls' ); ?></a>
					</div>
					...
					<div class="wbcom-addons-plugins-card">
						<div class="wbcom-addons-card-details">
							...
							<div class="wbcom-addons-card-button">								
								...
								<a href="https://docs.wbcomdesigns.com/doc_category/advanced-username-manager/" class="wbcom-addons-button wbcom-purchase" target="_blank"><?php esc_html_e( 'Docs', 'buddypress-polls' ); ?></a>
							</div>
						</div>		
					</div>
					<div class="wbcom-addons-plugins-card">
						<div class="wbcom-addons-card-details">
							...
							<div class="wbcom-addons-card-button">								
								...
								<a href="https://docs.wbcomdesigns.com/doc_category/buddylists/" class="wbcom-addons-button wbcom-purchase" target="_blank"><?php esc_html_e( 'Docs', 'buddypress-polls' ); ?></a>
							</div>
						</div>		
					</div>
					<div class="wbcom-addons-plugins-card">
						<div class="wbcom-addons-card-details">
							...
							<div class="wbcom-addons-card-button">								
								...
								<a href="https://docs.wbcomdesigns.com/doc_category/bp-scheduled-activity/" class="wbcom-addons-button wbcom-purchase" target="_blank"><?php esc_html_e( 'Docs', 'buddypress-polls' ); ?></a>
							</div>
						</div>		
					</div>
					<div class="wbcom-addons-plugins-card">
						<div class="wbcom-addons-card-details">
							...
							<div class="wbcom-addons-card-button">								
								...
								<a href="https://docs.wbcomdesigns.com/doc_category/bp-anonymous-activity/" class="wbcom-addons-button wbcom-purchase" target="_blank"><?php esc_html_e( 'Docs', 'buddypress-polls' ); ?></a>
							</div>
						</div>		
					</div>
					<div class="wbcom-addons-plugins-card">
						<div class="wbcom-addons-card-details">
							...
							<div class="wbcom-addons-card-button">								
								...
								<a href="https://docs.wbcomdesigns.com/doc_category/buddypress-edit-activity/" class="wbcom-addons-button wbcom-purchase" target="_blank"><?php esc_html_e( 'Docs', 'buddypress-polls' ); ?></a>
							</div>
						</div>		
					</div>
					<div class="wbcom-addons-plugins-card">
						<div class="wbcom-addons-card-details">
							...
							<div class="wbcom-addons-card-button">								
								...
								<a href="https://docs.wbcomdesigns.com/doc_category/wp-stories/" class="wbcom-addons-button wbcom-purchase" target="_blank"><?php esc_html_e( 'Docs', 'buddypress-polls' ); ?></a>
							</div>
						</div>		
					</div>
					<div class="wbcom-addons-plugins-card">
						<div class="wbcom-addons-card-details">
							...
							<div class="wbcom-addons-card-button">								
								...
								<a href="https://docs.wbcomdesigns.com/doc_category/bp-business-profile/" class="wbcom-addons-button wbcom-purchase" target="_blank"><?php esc_html_e( 'Docs', 'buddypress-polls' ); ?></a>
							</div>
						</div>		
					</div>
					<div class="wbcom-addons-plugins-card">
						<div class="wbcom-addons-card-details">
							...
							<div class="wbcom-addons-card-button">								
								...
								<a href="https://docs.wbcomdesigns.com/doc_category/buddypress-moderation-pro/" class="wbcom-addons-button wbcom-purchase" target="_blank"><?php esc_html_e( 'Docs', 'buddypress-polls' ); ?></a>
							</div>
						</div>		
					</div>
					<div class="wbcom-addons-plugins-card">
						<div class="wbcom-addons-card-details">
							...
							<div class="wbcom-addons-card-button">								
								...
								<a href="https://docs.wbcomdesigns.com/doc_category/buddypress-resume-manager/" class="wbcom-addons-button wbcom-purchase" target="_blank"><?php esc_html_e( 'Docs', 'buddypress-polls' ); ?></a>
							</div>
						</div>		
					</div>
					<div class="wbcom-addons-plugins-card">
						<div class="wbcom-addons-card-details">
							...
							<div class="wbcom-addons-card-button">								
								...
								<a href="https://docs.wbcomdesigns.com/doc_category/buddypress-polls/" class="wbcom-addons-button wbcom-purchase" target="_blank"><?php esc_html_e( 'Docs', 'buddypress-polls' ); ?></a>
							</div>
						</div>		
					</div>
					<div class="wbcom-addons-plugins-card">
						<div class="wbcom-addons-card-details">
							...
							<div class="wbcom-addons-card-button">								
								...
								<a href="https://docs.wbcomdesigns.com/doc_category/buddypress-private-community-pro/" class="wbcom-addons-button wbcom-purchase" target="_blank"><?php esc_html_e( 'Docs', 'buddypress-polls' ); ?></a>
							</div>
						</div>		
					</div>
					<div class="wbcom-addons-plugins-card">
						<div class="wbcom-addons-card-details">
							...
							<div class="wbcom-addons-card-button">								
								...
								<a href="https://docs.wbcomdesigns.com/doc_category/buddypress-profile-pro/" class="wbcom-addons-button wbcom-purchase" target="_blank"><?php esc_html_e( 'Docs', 'buddypress-polls' ); ?></a>
							</div>
						</div>		
					</div>
					<div class="wbcom-addons-plugins-card">
						<div class="wbcom-addons-card-details">
							...
							<div class="wbcom-addons-card-button">								
								...
								<a href="https://docs.wbcomdesigns.com/doc_category/buddypress-check-ins-pro/" class="wbcom-addons-button wbcom-purchase" target="_blank"><?php esc_html_e( 'Docs', 'buddypress-polls' ); ?></a>
							</div>
						</div>		
					</div>
					<div class="wbcom-addons-plugins-card">
						<div class="wbcom-addons-card-details">
							...
							<div class="wbcom-addons-card-button">								
								...
								<a href="https://docs.wbcomdesigns.com/doc_category/buddypress-ideapush-integration/" class="wbcom-addons-button wbcom-purchase" target="_blank"><?php esc_html_e( 'Docs', 'buddypress-polls' ); ?></a>
							</div>
						</div>		
					</div>
					<div class="wbcom-addons-plugins-card">
						<div class="wbcom-addons-card-details">
							...
							<div class="wbcom-addons-card-button">								
								...
								<a href="https://docs.wbcomdesigns.com/doc_category/bp-contact-me/" class="wbcom-addons-button wbcom-purchase" target="_blank"><?php esc_html_e( 'Docs', 'buddypress-polls' ); ?></a>
							</div>
						</div>		
					</div>
					<div class="wbcom-addons-plugins-card">
						<div class="wbcom-addons-card-details">
							...
							<div class="wbcom-addons-card-button">
								...
								<a href="https://docs.wbcomdesigns.com/doc_category/buddypress-member-blog/" class="wbcom-addons-button wbcom-purchase" target="_blank"><?php esc_html_e( 'Docs', 'buddypress-polls' ); ?></a>
							</div>
						</div>		
					</div>
					<div class="wbcom-addons-plugins-card">
						<div class="wbcom-addons-card-details">
							...
							<div class="wbcom-addons-card-button">								
								...
								<a href="https://docs.wbcomdesigns.com/doc_category/buddyvendor/" class="wbcom-addons-button wbcom-purchase" target="_blank"><?php esc_html_e( 'Docs', 'buddypress-polls' ); ?></a>
							</div>
						</div>		
					</div>
					<div class="wbcom-addons-plugins-card">
						<div class="wbcom-addons-card-details">
							...
							<div class="wbcom-addons-card-button">								
								...
								<a href="https://docs.wbcomdesigns.com/doc_category/buddypress-stats/" class="wbcom-addons-button wbcom-purchase" target="_blank"><?php esc_html_e( 'Docs', 'buddypress-polls' ); ?></a>
							</div>
						</div>		
					</div>
					<div class="wbcom-addons-plugins-card">
						<div class="wbcom-addons-card-details">
							...
							<div class="wbcom-addons-card-button">								
								...
								<a href="https://docs.wbcomdesigns.com/doc_category/who-viewed-my-profile-buddypress/" class="wbcom-addons-button wbcom-purchase" target="_blank"><?php esc_html_e( 'Docs', 'buddypress-polls' ); ?></a>
							</div>
						</div>		
					</div>
					<div class="wbcom-addons-plugins-card">
						<div class="wbcom-addons-card-details">
							...
							<div class="wbcom-addons-card-button">								
								...
								<a href="https://docs.wbcomdesigns.com/doc_category/buddypress-friend-follow-suggestion/" class="wbcom-addons-button wbcom-purchase" target="_blank"><?php esc_html_e( 'Docs', 'buddypress-polls' ); ?></a>
							</div>
						</div>		
					</div>
					<div class="wbcom-addons-plugins-card">
						<div class="wbcom-addons-card-details">
							...
							<div class="wbcom-addons-card-button">								
								...
								<a href="https://docs.wbcomdesigns.com/doc_category/buddypress-giphy/" class="wbcom-addons-button wbcom-purchase" target="_blank"><?php esc_html_e( 'Docs', 'buddypress-polls' ); ?></a>
							</div>
						</div>		
					</div>
					<div class="wbcom-addons-plugins-card">
						<div class="wbcom-addons-card-details">
							...
							<div class="wbcom-addons-card-button">								
								...
								<a href="https://docs.wbcomdesigns.com/doc_category/shortcode-for-buddypress-pro/" class="wbcom-addons-button wbcom-purchase" target="_blank"><?php esc_html_e( 'Docs', 'buddypress-polls' ); ?></a>
							</div>
						</div>		
					</div>
					<div class="wbcom-addons-plugins-card">
						<div class="wbcom-addons-card-details">
							...
							<div class="wbcom-addons-card-button">								
								...
								<a href="https://docs.wbcomdesigns.com/doc_category/buddypress-sticky-post/" class="wbcom-addons-button wbcom-purchase" target="_blank"><?php esc_html_e( 'Docs', 'buddypress-polls' ); ?></a>
							</div>
						</div>		
					</div>
					<div class="wbcom-addons-plugins-card">
						<div class="wbcom-addons-card-details">
							...
							<div class="wbcom-addons-card-button">
								...
								<a href="https://docs.wbcomdesigns.com/doc_category/buddypress-quotes/" class="wbcom-addons-button wbcom-purchase" target="_blank"><?php esc_html_e( 'Docs', 'buddypress-polls' ); ?></a>
							</div>
						</div>		
					</div>
					<div class="wbcom-addons-plugins-card">
						<div class="wbcom-addons-card-details">
							...
							<div class="wbcom-addons-card-button">								
								...
								<a href="https://docs.wbcomdesigns.com/doc_category/buddypress-auto-friends/" class="wbcom-addons-button wbcom-purchase" target="_blank"><?php esc_html_e( 'Docs', 'buddypress-polls' ); ?></a>
							</div>
						</div>		
					</div>
					<div class="wbcom-addons-plugins-card">
						<div class="wbcom-addons-card-details">
							...
							<div class="wbcom-addons-card-button">								
								...
								<a href="https://docs.wbcomdesigns.com/doc_category/buddypress-newsfeed/" class="wbcom-addons-button wbcom-purchase" target="_blank"><?php esc_html_e( 'Docs', 'buddypress-polls' ); ?></a>
							</div>
						</div>		
					</div>
					<div class="wbcom-addons-plugins-card">
						<div class="wbcom-addons-card-details">
							...
							<div class="wbcom-addons-card-button">								
								...
								<a href="https://docs.wbcomdesigns.com/doc_category/buddypress-status/" class="wbcom-addons-button wbcom-purchase" target="_blank"><?php esc_html_e( 'Docs', 'buddypress-polls' ); ?></a>
							</div>
						</div>		
					</div>
					<div class="wbcom-addons-plugins-card">
						<div class="wbcom-addons-card-details">
							...
							<div class="wbcom-addons-card-button">								
								...
								<a href="https://docs.wbcomdesigns.com/doc_category/buddypress-hashtags/" class="wbcom-addons-button wbcom-purchase" target="_blank"><?php esc_html_e( 'Docs', 'buddypress-polls' ); ?></a>
							</div>
						</div>		
					</div>
					<div class="wbcom-addons-plugins-card">
						<div class="wbcom-addons-card-details">
							...
							<div class="wbcom-addons-card-button">								
								...
								<a href="https://docs.wbcomdesigns.com/doc_category/buddypress-profanity/" class="wbcom-addons-button wbcom-purchase" target="_blank"><?php esc_html_e( 'Docs', 'buddypress-polls' ); ?></a>
							</div>
						</div>		
					</div>
				</div>
			...
			<div id="wbcom-learndash-extension" class="wbcom-bp-addons-plugins-list wbcom-bp-free-addon-plugins">
				<div class="wbcom-bp-addons-plugins-title-section">
					<h4 class="wbcom-plugin-heading"><?php esc_html_e( 'Extension for LearnDash', 'buddypress-polls' ); ?></h4>
					<a href="https://wbcomdesigns.com/plugins/learndash-add-ons/" class="wbcom-addons-button" target="_blank"><?php esc_html_e( 'View More Extensions', 'buddypress-polls' ); ?></a>
				</div>
				<div class="wbcom-addon-plugins-inner-wrapper">
					<div class="wbcom-addons-plugins-card">
						<div class="wbcom-addons-card-details">
							...
							<div class="wbcom-addons-card-button">								
								...
								<a href="https://docs.wbcomdesigns.com/doc_category/lms-notes/" class="wbcom-addons-button wbcom-purchase" target="_blank"><?php esc_html_e( 'Docs', 'buddypress-polls' ); ?></a>
							</div>
						</div>		
					</div>					
					<div class="wbcom-addons-plugins-card">
						<div class="wbcom-addons-card-details">
							...
							<div class="wbcom-addons-card-button">								
								...
								<a href="https://docs.wbcomdesigns.com/doc_category/learndash-wpforo/" class="wbcom-addons-button wbcom-purchase" target="_blank"><?php esc_html_e( 'Docs', 'buddypress-polls' ); ?></a>
							</div>
						</div>		
					</div>
					<div class="wbcom-addons-plugins-card">
						<div class="wbcom-addons-card-details">
							...
							<div class="wbcom-addons-card-button">								
								...
								<a href="https://docs.wbcomdesigns.com/doc_category/learndash-dashboard/" class="wbcom-addons-button wbcom-purchase" target="_blank"><?php esc_html_e( 'Docs', 'buddypress-polls' ); ?></a>
							</div>
						</div>		
					</div>					
				</div>
			...
			<div id="wbcom-themes-list" class="wbcom-bp-addons-plugins-list wbcom-bp-free-addon-plugins">
				<div class="wbcom-bp-addons-plugins-title-section">
					<h4 class="wbcom-plugin-heading"><?php esc_html_e( 'Our Themes', 'buddypress-polls' ); ?></h4>
					<a href="https://wbcomdesigns.com/themes/" class="wbcom-addons-button" target="_blank"><?php esc_html_e( 'View More Themes', 'buddypress-polls' ); ?></a>
				</div>
				<div class="wbcom-addon-plugins-inner-wrapper">
					<div class="wbcom-addons-plugins-card">
						<div class="wbcom-addons-card-details">
							...
							<div class="wbcom-addons-card-button">								
								...
								<a href="https://docs.wbcomdesigns.com/doc_category/wb-reign-theme/" class="wbcom-addons-button wbcom-purchase" target="_blank"><?php esc_html_e( 'Docs', 'buddypress-polls' ); ?></a>
							</div>
						</div>		
					</div>
					<div class="wbcom-addons-plugins-card">
						<div class="wbcom-addons-card-details">
							...
							<div class="wbcom-addons-card-button">								
								...
								<a href="https://docs.wbcomdesigns.com/doc_category/buddyx-theme/" class="wbcom-addons-button wbcom-purchase" target="_blank"><?php esc_html_e( 'Docs', 'buddypress-polls' ); ?></a>
							</div>
						</div>		
					</div>
					<div class="wbcom-addons-plugins-card">
						<div class="wbcom-addons-card-details">
							...
							<div class="wbcom-addons-card-button">								
								...
								<a href="https://docs.wbcomdesigns.com/doc_category/buddyx-free-theme/" class="wbcom-addons-button wbcom-purchase" target="_blank"><?php esc_html_e( 'Docs', 'buddypress-polls' ); ?></a>
							</div>
						</div>		
					</div>
					<div class="wbcom-addons-plugins-card">
						<div class="wbcom-addons-card-details">
							...
							<p><?php esc_html_e( 'A Free WordPress Knowledge base Theme. KnowX helps you set up a Knowledge Base in WordPress in less time than it takes to brew a coffee.', 'buddypress-polls' ); ?></p>
							<div class="wbcom-addons-card-button">								
								<a target="_blank" href="https://wbcomdesigns.com/downloads/knowx-theme/" class="wbcom-addons-button"><?php esc_html_e( 'View Details', 'buddypress-polls' ); ?></a>
								<a href="https://knowxtheme.com/docs/" class="wbcom-addons-button wbcom-purchase" target="_blank"><?php esc_html_e( 'Docs', 'buddypress-polls' ); ?></a>
							</div>
						</div>		
					</div>
				</div>
			...
			<div id="wbcom-free-extension" class="wbcom-bp-addons-plugins-list wbcom-bp-free-addon-plugins">
				<div class="wbcom-bp-addons-plugins-title-section">
					<h4 class="wbcom-plugin-heading"><?php esc_html_e( 'Our Free Extension', 'buddypress-polls' ); ?></h4>
					<a href="https://wbcomdesigns.com/plugins/buddypress/" class="wbcom-addons-button" target="_blank"><?php esc_html_e( 'View More Extensions', 'buddypress-polls' ); ?></a>
				</div>
				<div class="wbcom-addon-plugins-inner-wrapper">
					<div class="wbcom-addons-plugins-card">
						<div class="wbcom-addons-card-details">
							...
							<div class="wbcom-addons-card-button">								
								...
								<a href="https://docs.wbcomdesigns.com/docs/buddyx-theme/wbcom-essentials/installation-of-wbcom-essentials/" class="wbcom-addons-button wbcom-purchase" target="_blank"><?php esc_html_e( 'Docs', 'buddypress-polls' ); ?></a>
							</div>
						</div>		
					</div>
					<div class="wbcom-addons-plugins-card">
						<div class="wbcom-addons-card-details">
							...
							<div class="wbcom-addons-card-button">								
								...
								<a href="https://docs.wbcomdesigns.com/doc_category/buddypress-member-type/" class="wbcom-addons-button wbcom-purchase" target="_blank"><?php esc_html_e( 'Docs', 'buddypress-polls' ); ?></a>
							</div>
						</div>		
					</div>
					<div class="wbcom-addons-plugins-card">
						<div class="wbcom-addons-card-details">
							...
							<div class="wbcom-addons-card-button">								
								...
								<a href="https://docs.wbcomdesigns.com/doc_category/buddypress-ads/" class="wbcom-addons-button wbcom-purchase" target="_blank"><?php esc_html_e( 'Docs', 'buddypress-polls' ); ?></a>
							</div>
						</div>		
					</div>
					<div class="wbcom-addons-plugins-card">
						<div class="wbcom-addons-card-details">
							...
							<div class="wbcom-addons-card-button">								
								...
								<a href="https://docs.wbcomdesigns.com/doc_category/buddypress-recaptcha/" class="wbcom-addons-button wbcom-purchase" target="_blank"><?php esc_html_e( 'Docs', 'buddypress-polls' ); ?></a>
							</div>
						</div>		
					</div>
					<div class="wbcom-addons-plugins-card">
					...
					<div class="wbcom-addons-plugins-card">
						<div class="wbcom-addons-card-details">
							...
							<div class="wbcom-addons-card-button">								
								...
								<a href="https://docs.wbcomdesigns.com/doc_category/buddypress-woocommerce-integration/" class="wbcom-addons-button wbcom-purchase" target="_blank"><?php esc_html_e( 'Docs', 'buddypress-polls' ); ?></a>
							</div>
						</div>		
					</div>
					<div class="wbcom-addons-plugins-card">
						<div class="wbcom-addons-card-details">
							...
							<div class="wbcom-addons-card-button">								
								...
								<a href="https://docs.wbcomdesigns.com/doc_category/buddypress-activity-link-preview/" class="wbcom-addons-button wbcom-purchase" target="_blank"><?php esc_html_e( 'Docs', 'buddypress-polls' ); ?></a>
							</div>
						</div>		
					</div>
					<div class="wbcom-addons-plugins-card">
						<div class="wbcom-addons-card-details">
							...
							<div class="wbcom-addons-card-button">								
								...
								<a href="https://docs.wbcomdesigns.com/doc_category/buddypress-birthday/" class="wbcom-addons-button wbcom-purchase" target="_blank"><?php esc_html_e( 'Docs', 'buddypress-polls' ); ?></a>
							</div>
						</div>		
					</div>
					<div class="wbcom-addons-plugins-card">
						<div class="wbcom-addons-card-details">
							...
							<div class="wbcom-addons-card-button">								
								...
								<a href="https://docs.wbcomdesigns.com/doc_category/buddypress-redirect/" class="wbcom-addons-button wbcom-purchase" target="_blank"><?php esc_html_e( 'Docs', 'buddypress-polls' ); ?></a>
							</div>
						</div>		
					</div>
					<div class="wbcom-addons-plugins-card">
						<div class="wbcom-addons-card-details">
							...
							<div class="wbcom-addons-card-button">								
								...
								<a href="https://docs.wbcomdesigns.com/doc_category/buddypress-activity-bump/" class="wbcom-addons-button wbcom-purchase" target="_blank"><?php esc_html_e( 'Docs', 'buddypress-polls' ); ?></a>
							</div>
						</div>		
					</div>
					<div class="wbcom-addons-plugins-card">
						<div class="wbcom-addons-card-details">
							...
							<div class="wbcom-addons-card-button">								
								...
								<a href="https://docs.wbcomdesigns.com/doc_category/buddypress-lock/" class="wbcom-addons-button wbcom-purchase" target="_blank"><?php esc_html_e( 'Docs', 'buddypress-polls' ); ?></a>
							</div>
						</div>		
					</div>
					<div class="wbcom-addons-plugins-card">
						<div class="wbcom-addons-card-details">
							...
							<div class="wbcom-addons-card-button">								
								...
								<a href="https://docs.wbcomdesigns.com/doc_category/shortcodes-for-buddypress/" class="wbcom-addons-button wbcom-purchase" target="_blank"><?php esc_html_e( 'Docs', 'buddypress-polls' ); ?></a>
							</div>
						</div>		
					</div>
					<div class="wbcom-addons-plugins-card">
						<div class="wbcom-addons-card-details">
							...
							<div class="wbcom-addons-card-button">								
								...
								<a href="https://docs.wbcomdesigns.com/doc_category/buddypress-user-to-do-list/" class="wbcom-addons-button wbcom-purchase" target="_blank"><?php esc_html_e( 'Docs', 'buddypress-polls' ); ?></a>
							</div>
						</div>		
					</div>
					<div class="wbcom-addons-plugins-card">
						<div class="wbcom-addons-card-details">
							...
							<div class="wbcom-addons-card-button">								
								...
								<a href="https://docs.wbcomdesigns.com/doc_category/buddypress-job-manager/" class="wbcom-addons-button wbcom-purchase" target="_blank"><?php esc_html_e( 'Docs', 'buddypress-polls' ); ?></a>
							</div>
						</div>		
					</div>
					<div class="wbcom-addons-plugins-card">
						<div class="wbcom-addons-card-details">
							...
							<div class="wbcom-addons-card-button">								
								...
								<a href="https://docs.wbcomdesigns.com/doc_category/buddypress-group-review/" class="wbcom-addons-button wbcom-purchase" target="_blank"><?php esc_html_e( 'Docs', 'buddypress-polls' ); ?></a>
							</div>
						</div>		
					</div>
					<div class="wbcom-addons-plugins-card">
						<div class="wbcom-addons-card-details">
							...
							<div class="wbcom-addons-card-button">								
								...
								<a href="https://docs.wbcomdesigns.com/doc_category/buddypress-member-review/" class="wbcom-addons-button wbcom-purchase" target="_blank"><?php esc_html_e( 'Docs', 'buddypress-polls' ); ?></a>
							</div>
						</div>		
					</div>
					<div class="wbcom-addons-plugins-card">
						<div class="wbcom-addons-card-details">
							...
							<div class="wbcom-addons-card-button">								
								...
								<a href="https://docs.wbcomdesigns.com/doc_category/buddypress-check-ins/" class="wbcom-addons-button wbcom-purchase" target="_blank"><?php esc_html_e( 'Docs', 'buddypress-polls' ); ?></a>
							</div>
						</div>		
					</div>
					<div class="wbcom-addons-plugins-card">
						<div class="wbcom-addons-card-details">
							...
							<div class="wbcom-addons-card-button">								
								...
								<a href="https://docs.wbcomdesigns.com/doc_category/bp-activity-filter/" class="wbcom-addons-button wbcom-purchase" target="_blank"><?php esc_html_e( 'Docs', 'buddypress-polls' ); ?></a>
							</div>
						</div>		
					</div>
					<div class="wbcom-addons-plugins-card">
						<div class="wbcom-addons-card-details">
							...
							<div class="wbcom-addons-card-button">								
								...
								<a href="https://docs.wbcomdesigns.com/doc_category/buddypress-favorite-notification/" class="wbcom-addons-button wbcom-purchase" target="_blank"><?php esc_html_e( 'Docs', 'buddypress-polls' ); ?></a>
							</div>
						</div>		
					</div>
					<div class="wbcom-addons-plugins-card">
						<div class="wbcom-addons-card-details">
							...
							<div class="wbcom-addons-card-button">								
								...
								<a href="https://docs.wbcomdesigns.com/doc_category/buddypress-activity-social-share/" class="wbcom-addons-button wbcom-purchase" target="_blank"><?php esc_html_e( 'Docs', 'buddypress-polls' ); ?></a>
							</div>
						</div>		
					</div>
				</div>
