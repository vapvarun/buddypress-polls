...
<form method="post" action="admin.php?action=update_network_options">
	...
	<table class="form-table polls-general-options">
		...
		<tr>
			<th scope="row"><label for="blogname"><?php esc_html_e( 'Submit button & progress bar color', 'buddypress-polls' ); ?></label></th>
			<td>
			<label for>
			...
			<p class="description" id="tagline-description"><?php esc_html_e( 'Set submit button and progress bar background color.', 'buddypress-polls' ); ?>
			</p>
			</td>
		</tr>
