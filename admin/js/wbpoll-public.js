...
jQuery(document).ready(function ($) {
    ...
    $(document.body).on('click', '.wbpoll-listing-trig', function (e) {
    ...
    $(document.body).on('submit', '.wbpoll-form', function (e) {
        e.preventDefault();
    ...
    $('.wbpoll-guest-wrap').on('click', '.wbpoll-title-login a', function (e) {
        e.preventDefault();
