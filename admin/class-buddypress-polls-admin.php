			...
			<div class="wrap">
				...
				<div class="wbcom-wrap buddyPress-polls-header">
					...
					public static function wbpolls_shortcode($atts)
					{
						...
						$poll_list_output = WBPollHelper::poll_list(
							$user_id,
							$per_page,
							$current_page_number,
							$chart_type,
						...
						if (intval($poll_list_output['found'])) {
							...
							$content       .= esc_html__('No poll found', 'buddypress-polls');
						...
						if ($show_load_more && (int) $options['per_page'] != -1 && $options['per_page'] != '') {
							$content .= '<p class="wbpoll-listing-more"><a class="wbpoll-listing-trig" href="#" data-user_id="' . intval($user_id) . '" data-security="' . $nonce . '" data-page-no="' . $current_page_number . '"  data-busy ="0" data-per-page="' . $per_page . '">' . esc_html__(
								'View More Polls',
								'buddypress-polls'
							) . '<span class="wbvoteajaximage wbvoteajaximagecustom"></span></a></p>';
						}

						$content .= '</div>';

						return $content;
					} //end wbpolls_shortcode()
					...
					public function wbpoll_get_answer_template()
					{
						...
						die();
					} //end wbpoll_get_answer_template()
					...
					public function poll_display_methods_text_result($poll_id, $reference = 'shortcode', $poll_result)
					{
						...
						if ($total > 0) {
							?>
							<p><?php echo sprintf(__('Total votes: %d', 'buddypress-polls'), number_format_i18n($total)); ?></p>
							<div class="wbpolls-question-results <?php echo $class['class']; ?>">
								<?php
								$total_percent = 0;
								...
								?>
									<li style="<?php echo $color_style; ?>"><strong><?php echo $answer_title ?> : <?php echo  $vote_count . ' (' . number_format_i18n(
																														$percent,
																														2
																													) . '%)'; ?></strong></li>
									<div class="bpolls-item-width-wrapper">
										<div class="wbpoll-question-choices-item-votes-bar" style="width:100%;background-color:#ea6464;"></div>
								...
								if ($total_percent > 0) {
									...
									?>
										<div class="wbpoll-question-choices-item">
											<div class="wbpoll-question-choices-item-container">
												...
												?>
													<div class="wbpoll-question-choices-item-content-container">
														<div class="wbpoll-question-choices-item-content">
															...
															<div class="wb-poll-lightbox poll-audio-lightbox lightbox-<?php echo $index; ?>" style="display:none;">
																<div class="close" data-id="<?php echo $index; ?>"><svg class="pswp__icn" aria-hidden="true" width="12" height="12" viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg">
																		<path fill="currentColor" d="M11.53 1.53A.75.75 0 0 0 10.47.47L6 4.94 1.53.47A.75.75 0 1 0 .47 1.53L4.94 6 .47 10.47a.75.75 0 1 0 1.06 1.06L6 7.06l4.47 4.47a.75.75 0 1 0 1.06-1.06L7.06 6l4.47-4.47Z"></path>
																	</svg></div>
												...
												?>
													<div class="wbpoll-question-choices-item-label">
														<div class="wbpoll-question-choices-item-votes">
															<div class="wbpoll-question-choices-item-text"><strong><?php echo $answer_title; ?></strong><strong class="votecount-right"> <?php echo $vote_count; ?> Votes</strong></div>
														</div>
													<?php
												} else {
													?>
														<div class="wbpoll-question-choices-item-label">
															<div class="wbpoll-question-choices-item-votes">
																<div class="wbpoll-question-choices-item-text"><strong><?php echo $answer_title; ?>'</strong><strong class="votecount-right"><?php echo $vote_count; ?> Vote</strong></div>
															</div>
														<?php
													}
														?>
														<div class="bpolls-item-width-wrapper">
															<div class="wbpoll-question-choices-item-votes-bar" style="width:<?php echo number_format_i18n($re_percent, 2); ?>%;background-color:<?php echo $colors[$index]; ?>"></div>
															<div class="wbpoll-vote-percent-data" style="<?php echo $color_style; ?>"><?php echo number_format_i18n($re_percent, 2) ?>%</div>
														</div>
														</div>
													</div>
											</div>
